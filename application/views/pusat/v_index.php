				...
				<nav class="sidebar-nav">
					<ul id="sidebarnav">
						...
						<li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="fa fa-address-book"></i><span
								 class="hide-menu">Laporan Program & Kegiatan</span></a>
							<ul aria-expanded="false" class="collapse">
			...
			<div class="container-fluid">
				...
				<div class="row page-titles">
					<div class="col-md-5 align-self-center">
						<h4 class="text-themecolor mt-2">Pagu Dashboard</h4>
					</div>
								...
								<div class="col-md-12">
									<div class="d-flex no-block align-items-center">
										<div>
											...
											<p class="text-muted">Kode Program</p>
										</div>
								...
								<div class="col-12">
									<div class="ml-auto">
										<h2 class="counter text-primary">
											<?php echo $budget->total_kode_program;?>
										</h2>
									</div>
								</div>
							</div>
								...
								<div class="col-md-12">
									<div class="d-flex no-block align-items-center">
										<div>
											...
											<p class="text-muted">Nama Program</p>
										</div>
								...
								<div class="col-md-12">
									<div class="d-flex no-block align-items-center">
										<div>
											...
											<p class="text-muted">Total Amount Budget</p>
										</div>
								...
								<div class="col-12">
									<div class="ml-auto">
										<h2 class="counter text-purple">
											<?php echo "Rp ".number_format($budget->total_amount);?>
										</h2>
									</div>
								</div>
							</div>
				...
				<div class="row page-titles">
					<div class="col-md-5 align-self-center">
						<h4 class="text-themecolor">Pelaksanaan Dashboard</h4>
					</div>
					<div class="col-md-7 align-self-center text-right">
						<div class="d-flex justify-content-end align-items-center">
						...
						<div class="card-body">
							<div class="row">
								...
								<div class="col-12">
									<div class="ml-auto">
										<h2 class="counter text-primary">
											<?php echo $pelaksanaan->total_kode_program;?>
										</h2>
									</div>
								</div>
							</div>
						...
						<div class="card-body">
							<div class="row">
								...
								<div class="col-12">
									<div class="ml-auto">
										<h2 class="counter text-cyan">
											<?php echo $pelaksanaan->total_program;?>
										</h2>
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="col-md-12">
									<div class="d-flex no-block align-items-center">
										<div>
											<h3><i class="fa fa-dollar"></i></h3>
											<p class="text-muted">Total Amount Pelaksanaan</p>
										</div>
								...
								<div class="col-12">
									<div class="ml-auto">
										<h2 class="counter text-purple">
											<?php echo "Rp ".number_format($pelaksanaan->total_amount);?>
										</h2>
									</div>
								</div>
							</div>
