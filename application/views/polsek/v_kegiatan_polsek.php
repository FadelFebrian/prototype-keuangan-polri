        ...
        <header class="topbar">
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="<?php echo base_url();?>C_polsek/index">
                        <!-- Logo icon --><b>
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="fa fa-address-book"></i><span class="hide-menu">Kegiatan</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="<?php echo base_url();?>C_polsek/viewKegiatan">Program/Kegiatan Polres</a></li>
                            </ul>
                        </li>
							...
							<div class="modal-content block3">
								...
								<div class="modal-body">
									<div class="form-group row">
										<label class="col-md-2 col-form-label">Detail Kegiatan</label>
										<div class="col-md-10">
											<input type="text" name="detail_kegiatan" id="detail_kegiatan" class="form-control" placeholder="Detail Kegiatan">
										</div>
									</div>
									<div class="form-group row">
										<label class="col-md-2 col-form-label">Ammount</label>
										<div class="col-md-10">
									...
									<div class="form-group row">
										...
										<div class="col-md-10">
											<input type="text" name="bukti_transaksi" id="bukti_transaksi" class="form-control" placeholder="Bukti Transaksi">
										</div>
									</div>
								</div>
