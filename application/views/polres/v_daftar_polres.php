<body class="skin-blue fixed-layout">
							...
							<div class="modal-content block3">
								...
								<div class="modal-body">
									...
									<div class="form-group row">
										...
										<div class="col-md-10">
											<input type="text" name="tipe_polres" id="tipe_polda" class="form-control" placeholder="Tipe">
										</div>
									</div>
								</div>
	...
	<script>
		...
		function save_data() {
			...
			if (save_method == 'add') {
				url = '<?php echo base_url();?>C_pusat/tambahPolres';
			} else {
				url = '<?php echo base_url();?>C_pusat/updatePolres';
			}
			$.ajax({
				url: url,
				type: 'POST',
		...
		function edit_data(id) {
			...
			$.ajax({
				url: "<?php echo base_url();?>C_pusat/editPolres/" + id,
				type: 'GET',
				dataType: 'JSON',
				success: function (data) {
					$('[name="id"]').val(data.id);
					...
					$('[name="tipe_polres"]').val(data.tipe_polres);
		...
		function delete_data(id) {
			if (confirm('Apakah Yakin Ingin Hapus Data Ini?')) {
				...
				$.ajax({
					url: '<?php echo base_url();?>C_pusat/deletePolres/' + id,
					type: 'POST',
					dataType: 'JSON',
					success: function (data) {
						location.reload();
