			...
			<div class="container-fluid">
				...
				<div class="row page-titles">
					<div class="col-md-5 align-self-center">
						<h4 class="text-themecolor">Pagu</h4>
					</div>
								...
								<div class="col-md-12">
									<div class="d-flex no-block align-items-center">
										<div>
											...
											<p class="text-muted">Total Kode Program</p>
										</div>
									</div>
								</div>
								<div class="col-md-12">
									<div class="ml-auto">
										<h2 class="counter text-primary">
											<?php echo $pagu->total_kode_program;?>
										</h2>
									</div>
								</div>
								...
								<div class="col-md-12">
									<div class="d-flex no-block align-items-center">
										<div>
											...
											<p class="text-muted">Total Program</p>
										</div>
								...
								<div class="col-md-12">
									<div class="d-flex no-block align-items-center">
										<div>
											...
											<p class="text-muted">Amount Budget</p>
										</div>
								...
								<div class="col-12">
									<div class="ml-auto">
										<h2 class="counter text-purple">
											<?php echo "Rp. ".number_format($pagu->total_amount);?>
										</h2>
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="col-md-12">
									<div class="d-flex no-block align-items-center">
										<div>
											<h3><i class="fa fa-dollar"></i></h3>
											<p class="text-muted">Amount Pelaksanaan</p>
										</div>
								...
								<div class="col-12">
									<div class="ml-auto">
										<h2 class="counter text-purple pb-2">
